...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $licenseDonkeyKong
            ->setName('Donkey Kong')
            ->setSlug('donkey-kong')
            ->setDescription('La saga Donkey Kong met en scène une famille de signes, les Kong, dont le personnage principal de la majorité des jeux est Donkey Kong.<br/><br/>On peut y retrouver plusieurs styles de jeux tels que des jeux de plateforme avec la série des Donkey Kong Country, ou la famille Kong est confrontée aux Kremlings dirigés par King K. Rool, dont les motivations de ce dernier va évoluer entre chaque jeux. Il y a également des jeux de courses avec Donkey Kong Jet Race et Diddy Kong Racing.')
        ...
        $licensePokemon
            ->setName('Pokémon')
            ->setSlug('pokemon')
            ->setDescription("Les jeux Pokémon principaux sont des RPG qui mettent en scène un(e) jeune adolescent(e), souhaitant devenir maître de la ligue Pokémon. Pour ce faire il va quitter son village natal et choisir son premier Pokémon et partir à la conquête des badges d'arène afin de pour accéder à la ligue. Tout au long des jeux le joueur pourra agrandir son équipe de combat pour avoir jusqu'à six Pokémons. Dans certain de ces jeux, en plus de l'objectif ultime qu'est la ligue, le personnage principal sera mêlé à une intrigue parallèle impliquant un groupe de personnes mal intentionné se faisant appeler \"Team\", la plus célèbre d'entre elles est la Team Rocket faisant du trafic de Pokémon pour les revendre aux plus offrant ou les utiliser à leurs propres fins.<br/><br/>D'autres jeux sont également disponibles dans l'univers de Pokémon, comme les Pokémon Ranger, les Pokémon Donjon Mystère, Détective Pikachu ou encore Pokémon Snap.")
        ...
        $licenseSuperMario
            ->setName('Super Mario')
            ->setSlug('super-mario')
            ->setDescription("Super Mario met en scène le célèbre plombier moustachu créé par Shigeru Miyamoto : Mario. Les jeux de la franchise Super Mario ont rassemblés beaucoup de jeux différents au fil du temps. Les plus célèbres sont les jeux de plateforme, dont le premier est Super Mario Bros. sortie sur la Famicom au Japon et sur la NES pour le reste du monde.<br/><br/>Ces jeux mettent en scène une intrigue simple,  Mario va devoir sauver la princesse Peach qui s'est fait kidnappée par le roi des Koopa : Bowser. Pour cela Mario va devoir traverser une série de niveaux divers et variés, dans lesquels il va devoir affronter des ennemis et réussir les phases de plateforme.")
        ...
        $licenseSuperSmashBros
            ...
            ->setDescription("Super Smash Bros met en scène les personnages de l'univers Nintendo ainsi que d'autres issus de licence d'éditeur tiers dans des jeux de combats et plateforme. On pourra donc y voir Link et Bowser affronter King K. Rool et Pikachu lors d'un macth. Tous comme les combattants, les terrains de combat sont tirés  des jeux de la franchise Nintendo. A fur et à mesure de la sortie des jeux, de nouveaux personnages viennent se rajouter au casting, ils ne sont pas tous jouables sur tous les jeux. Seul Smash Bros Ultimate a réunit l'intégralité des combattants qui sont apparus dans les anciens jeux, tout en rajoutant des nouveaux.<br/><br/>Dans certains jeux, un mode aventure est disponible, racontant un scénario inédit impliquant tous les combattants. Ce mode est d'ailleurs l'un des moyens pour débloquer les combattants, car ils ne sont pas tous disponibles au début du jeu.")
        ...
        $characterBowser
            ...
            ->setDescription("Bowser, de son nom complet Roi Bowser Koopa Sr., est le principal antagoniste de l'Univers de Mario, et le boss final de nombreux jeux de la franchise. Il est le roi des Koopas, mais beaucoup d'autres espèces lui obéissent, et forme une grande armée pour l'aider à conquérir le Royaume Champignon. Il a un fils du nom de Bowser Jr..<br/><br/>Sa principale activité consiste à enlever la princesse Peach afin de pouvoir régner sur le royaume Champignon, ce qui fait de lui l'ennemi principal de Mario et ses amis.<br/><br/>À l'instar du Dr. Eggman ou encore de Ganondorf, il est l'un des méchants les plus reconnaissables du monde des jeux vidéos.")
            ->setGender('M');
        ...
        $characterYoshi
            ...
            ->setDescription("Yoshi est un personnage qui fait parti de l'espèce des Yoshis vivant sur l'île des Yoshis. Il est apparu pour la première fois dans Super Mario World et accompagne Mario et ses amis dans plusieurs jeux. Il sert généralement de monture à Mario mais peut être aussi au centre de certains jeux dont il est le personnage principal.<br/><br/>Yoshi se caractérise par sa capacité à sauter très haut et de pouvoir planer quelques secondes une fois en l'air. Il peut également gober des ennemis et les transformer en œuf qu'il peut utiliser comme projectiles.")
            ->setGender('M');
        ...
        $itemBanane
            ...
            ->setDescription("Dans la série des jeux Donkey Kong, la banane sert de collectable dans le niveau, au même titre que les pièces dans les jeux Mario. Dans les jeux Smash Bros et Mario Kart, c'est un objet permettant de faire glisser les combattants/karts quand ils entrent en contact avec.");
        ...
        $itemBouclierHylien
            ...
            ->setDescription("Le Bouclier d'Hylia ou bouclier Hylien est le bouclier récurrent et emblématique de la série. Avec l'épée de Légende, ce bouclier est un véritable symbole de la série. Il arbore les motifs de la Triforce et du célestrier vermeil de Link dans Skyward Sword. C'est un bouclier indestructible que peut résister à toutes les attaques, contrairement aux boucliers en bois qu'on obtient au début des jeux Zelda. Seul exception dans Breath of the Wild où tous les équipements sont destructibles, mais il reste tout de même le bouclier le plus résistant du jeu.");
        ...
        $itemMasterSword
            ...
            ->setDescription("L’Épée de Légende, aussi appelée Excalibur ou Master Sword, est l'épée la plus emblématique de la série des Zelda. Elle sert à repousser le mal, ou plus généralement repousser Ganon, mais aussi à acquérir de nouveaux pouvoirs. Elle est souvent associée avec le Bouclier d'Hylia. Dans Skyward Sword, on découvre son origine et comment celle-ci est passée d'épée divine à épée de légende grâce aux trois flammes sacrées et la bénédiction de la déesse Hylia.");
        ...
        $itemMarteau
            ...
            ->setDescription("Dans les jeux Paper Mario, le marteau est l'une des deux attaques principales que Mario pourra utiliser avec le saut.<br/><br/>Dans les jeux Smash Bros, le marteau est une arme de frappe. Une fois attrapé, le joueur se met à frapper rapidement avec, sans arrêt, pendant quelques instants . Si un adversaire le touche, il sera éjecté et souffrira de 22% dommages (30% dans Smash Bros. 64], ce qui en fait l'une des armes les plus \"effrayantes\" de la série.");
        ...
        $itemSuperChampi
            ...
            ->setDescription("Le Super champignon, parfois abrégé Super champi, est un champignon rouge et blanc avec des yeux globuleux. C'est un objet très récurrent de la série Super Mario.<br/><br/>La plupart du temps, le Super champignon fait grandir le joueur, lui permettant de détruire les briques avec sa tête et de résister à une attaque sans mourir. C'est l'objet le plus emblématique de toute la série.");
        ...
        $gameZeldaBotw
            ...
            ->setHistory("«<i>Depuis les temps les plus reculés, l'histoire de la famille royale d'Hyrule est intimement liée à celle du Fléau, ce monstre que l'on nomme Ganon. Chaque fois qu'il s'abat sur Hyrule, un jeune garçon et la princesse du royaume, l'âme du Héros et le sang de la Déesse, s'allient pour restaurer la paix.  [...]</i> » telle est la légende racontée dans le royaume d'Hyrule depuis la nuit des temps.<br/><br/>Le Fléau s'est éveillé il y a 100 ans et réussit à ravager le royaume d'Hyrule en prenant le contrôle des gardiens et des créatures divines, des machines issues de la technologie Sheikah, créées pour aider le héros et la princesse dans leur tâche. Grâce à cela Ganon a réussit à mettre en échec Link et Zelda, ces derniers tentant de fuir le chaos, se font rattraper par les hordes de gardiens et Link finit par tomber au combat. Zelda l'envoie au sanctuaire de la renaissance afin qu'il puisse guérir, pendant ce temps, la princesse retourne au château d'Hyrule afin de retenir Ganon dans le château d'Hyrule<br/><br/>Le début du jeux commence au réveil de Link, après 100 ans de sommeil en cryostase. Guidé par un vieil homme qui se révèle être le spectre roi d'Hyrule, Link va se diriger vers Cocorico où Impa va le guider dans sa quête pour retrouver ses souvenirs et terrasser le Fléau.")
