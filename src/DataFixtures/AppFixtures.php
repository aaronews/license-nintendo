...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $licenseDonkeyKong
            ->setName('Donkey Kong')
            ->setSlug('donkey-kong')
            ->setDescription('La saga Donkey Kong met en scène une famille de signes, les Kong, dont le personnage principal de la majorité des jeux est Donkey Kong.<br/><br/>On peut y retrouver plusieurs style de jeux tels que des jeux de plateforme avec la série des Donkey Kong Country, ou la famille Kong est confronté aux Kremlings dirigés par King K. Rool, dont les motivations de ce dernier va évoluer entre chaque jeu. Il y a également des jeux de course avec Donkey Kong Jet Race et Diddy Kong Racing.')
        ...
        $licensePokemon
            ->setName('Pokémon')
            ->setSlug('pokemon')
            ->setDescription("Les jeux Pokémon principaux sont des RPG mettent en scène un(e) jeune adolescent(e), souhaitant devenir maître de la ligue Pokémon. Pour ce faire il va quitter son village natal et choisir son premier Pokémon et partir à la conquête des badges d'arène afin de pour accéder à la ligue. Tout au long des jeux le joueur pourra agrandir son équipe de combat pour avoir jusqu'à six Pokémons. Dans certain de ces jeux, en plus de l'objectif ultime qu'est la ligue, le personnage principal sera mêlé à une intrigue parallèle impliquant un groupe de personnes mal intentionné se faisant appelé \"Team\", la plus célèbre d'entre elles est la Team Rocket faisait du trafic de Pokémon pour les revendre aux plus offrant ou les utiliser à leurs propres fins.<br/><br/>D'autres jeux sont également disponibles dans l'univers de Pokémon, comme les Pokémon Ranger, les Pokémon Donjon Mystère, Détective Pikachu ou encore Pokémon Snap.")
        ...
        $licenseSuperMario
            ->setName('Super Mario')
            ->setSlug('super-mario')
            ->setDescription("Super Mario met en scène le célèbre plombier moustachu créer par Shigeru Miyamoto : Mario. Les jeux de la franchise Super Mario a rassemblé beaucoup de jeux différents au fil du temps. Les plus célèbres sont les jeux de plateforme, dont le premier est Super Mario Bros. sortie sur la Famicom au Japon et sur la NES pour le reste du monde.<br/><br/>Ces jeux mettent en scène une intrigue simple, Mario va devoir sauver la princesse Peach qui s'est fait kidnapper par le roi des Koopa : Bowser. Pour cela Mario va devoir traverser une série de niveaux divers et variés, dans lesquels il va devoir affronter des ennemis et réussir les phases de plateformes.")
        ...
        $licenseSuperSmashBros
            ...
            ->setDescription("Super Smash Bros met en scène les personnages de l'univers Nintendo ainsi que d'autres issus de licence d'éditeur tiers dans des jeux de combats et plateformes. On pourra donc y voir Link et Bowser affronter King K. Rool et Pikachu lors d'un match. Tout comme les combattants, les terrains de combat sont tirés des jeux de la franchise Nintendo. A fur et à mesure de la sortie des jeux, de nouveaux personnages viennent se rajouter au casting, ils ne sont pas tous jouables sur tous les jeux. Seul Smash Bros Ultimate a réuni l'intégralité des combattants qui sont apparu dans les anciens jeux, tout en rajoutant des nouveaux.<br/><br/>Dans certains jeux, un mode aventure est disponible, racontant un scénario inédit impliquant tous les combattants. Ce mode est d'ailleurs un des moyens pour débloquer les combattants, car ils ne sont pas tous disponibles au début du jeu.")
        ...
        $consoleGba
            ...
            ->setDescription("La Game Boy Advance (abrégée en GBA) est une console de jeux vidéo portable créée par Nintendo en 2001. Elle dispose d'un écran couleur et d'un processeur 32-bits, ce qui en faisait à sa sortie la console portable la plus performante.<br/><br/>Descendante de la Game Boy Color, elle offre des performances légèrement supérieures aux consoles de salon 16 bits. La GBA n'étant pas zonée, il est possible de jouer à des jeux américains et japonais sur une console européenne. De plus, le faible coût de développement des jeux pour consoles portables fait que de nombreuses productions sortent sur Game Boy Advance.<br/><br/>La possibilité de jouer à quatre, parfois avec une seule cartouche de jeu, en reliant les Game Boy Advance entre elles est un autre point fort. Son gros point faible bien qu'il existe des accessoires pour compenser ce défaut est l'absence de rétro-éclairage, rendant l'affichage très sombre. C'est l'un des points qui ont amené Nintendo a sortir la Game Boy Advance SP, un modèle disposant d'un écran éclairé par le biais de diodes sur ses côtés.")
        ;
        ...
        $consoleN64
            ...
            ->setDescription("La Nintendo 64 également connue sous les noms Ultra 64 ou Project Reality lors de son développement est la 3eme console de salon de Nintendo. Sortie en 1997 en Europe en collaboration avec Silicon Graphics, elle fut la dernière console de la cinquième génération à être sortie.<br/><br/>La Nintendo 64 a certaines particularités : c'est une console 64 bits contrairement à la Saturn ou la Playstation, ses concurrentes qui sont des consoles 32 bits. L'entreprise a préféré utiliser un support cartouche plus rentable pour Nintendo, mais plus contraignant et plus cher que le support CD. Elle innove en utilisant un stick analogique sur sa manette qui se révélera indispensable pour les jeux en 3D, elle était également la première console à disposer de quatre ports manettes pour les jeux multijoueur.<br/><br/>Cette console à permit à Nintendo d'engager la transition de la 2D à la 3D de nombreuses de ces licences de jeux. Comme Mario, avec Mario 64 ; Zelda avec Zelda Ocarina of Time et Zelda Majorés Mask ou encore Star Fox avec Star Fox 64.")
        ;
